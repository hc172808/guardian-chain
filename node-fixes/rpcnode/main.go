...
import (
        ...
        "github.com/gydschain/rpcnode/consensus"
...
func main() {
        root := &cobra.Command{
                ...
                Long: `GYDS RPC Node — a dedicated public JSON-RPC and WebSocket endpoint for the GYDS Chain.
Serves wallet connections, dApps, block explorers, and MetaMask integration.`,
        }
...
func runNode() error {
        ...
        // rpc/server.go NewServer signature: (chain, port, wsPort, host, corsOrigins)
