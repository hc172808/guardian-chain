...
<div class="card">
  <div class="header">
    ...
    <span class="badge">Chain ID: 198282</span>
...
async function saveConfig(){
  ...
  document.getElementById('done-content').innerHTML=
    ...
    '<div class="cmd-box"><strong>Network Name:</strong> GYDS Chain &nbsp;|&nbsp; <strong>Chain ID:</strong> 198282 &nbsp;|&nbsp; <strong>RPC URL:</strong> '+(data.domain?'https://'+data.domain:'http://YOUR_SERVER_IP:'+gv('rpc_port'))+'</div>';
