...
`, version)
        ...
        chainConfig := blockchain.Config{
                ...
                GenesisGYDS:       bigIntFromString("100000000000000000000000000"), // 100M GYDS to founder
                GenesisGYD:        big.NewInt(0),                                    // GYD must be minted
        }
        ...
        posConfig := consensus.PoSConfig{
                ...
                RewardPerBlock:     bigIntFromString("2000000000000000000"), // 2 tokens
        }
