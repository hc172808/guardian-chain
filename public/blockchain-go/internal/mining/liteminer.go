...
// LiteClientAPI is the subset of liteclient.Client used by LiteMiner.
// Defined here to avoid an import cycle (liteclient imports mining).
type LiteClientAPI interface {
...
func NewLiteMiner(client LiteClientAPI, config LiteMinerConfig) (*LiteMiner, error) {
        return &LiteMiner{
                config:     config,
                client:     client,
