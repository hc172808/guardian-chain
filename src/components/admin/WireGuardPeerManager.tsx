    ...
    <div className="space-y-6">
      ...
      <GlassCard className="p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <div className="flex gap-2">
              <input value={serverPubKey} onChange={e => setServerPubKey(e.target.value)}
                placeholder="e9egJMy5zffDCgl3xcLa54Dy9Ib0K1UKzTc794K4Ago="
          ...
          <div className="space-y-1">
            <label className="text-xs text-muted-foreground">VPN tunnel network</label>
            <input value={`${WG_SERVER_IP}/24`} readOnly
      ...
      {approvedPeers.length > 0 && (
        <GlassCard className="p-3 flex items-center justify-between">
          <div className="flex items-center gap-4 text-xs">
            ...
            <span className="text-muted-foreground">Subnet: <strong className="text-foreground font-mono">{WG_SUBNET}</strong></span>
          </div>
          <Button variant="outline" size="sm" className="gap-1.5 text-xs"
            onClick={() => {
